...
const ErrorAlert: React.FC<ErrorAlertProps> = ({ message }) => {
  return (
    <div className="rounded-xl border p-4 border-error-500 bg-error-50 dark:border-error-500/30 dark:bg-error-500/15 mt-4">
      <div className="flex items-start gap-3">
        ...
        <div>
          <h4 className="mb-1 text-sm font-semibold text-gray-800 dark:text-white/90">Erro!</h4>
