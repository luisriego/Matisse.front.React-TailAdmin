...
const SuccessAlert: React.FC<SuccessAlertProps> = ({ message }) => {
  return (
    <div className="rounded-xl border p-4 border-success-500 bg-success-50 dark:border-success-500/30 dark:bg-success-500/15 mt-4">
      <div className="flex items-start gap-3">
        ...
        <div>
          <h4 className="mb-1 text-sm font-semibold text-gray-800 dark:text-white/90">Sucesso!</h4>
